...
<template>
    ...
    >
        ...
        <div class="w-full max-w-4xl mb-6">
            <div
                class="bg-green-50 border border-green-200 rounded-lg p-4 text-center dark:bg-green-900/20 dark:border-green-800"
            >
                <h2 class="text-lg font-semibold text-green-800 dark:text-green-300">🚀 Deployment Successful!</h2>
                <p class="text-sm text-green-600 dark:text-green-400 mt-1">
                    Last deployed: {{ new Date().toLocaleString('et-EE', { timeZone: 'Europe/Tallinn' }) }}
                </p>
                <p class="text-xs text-green-500 dark:text-green-500 mt-2">Version: {{ new Date().getTime() }}</p>
            </div>
        </div>
